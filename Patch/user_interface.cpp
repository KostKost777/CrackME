...
SelectedArea DetectPressButton(size_t x, size_t y)
{
    //printf("X_COORD: %lu\n Y_COORD: %lu\n\n", x, y);
...
SelectedArea RunUserInterface()
{
    SelectedArea area = UNKNOWN;
    ...
    while (sfRenderWindow_isOpen(window)) 
    {
        while (sfRenderWindow_pollEvent(window, &event)) 
        {
            ...
            {
                area = DetectPressButton((size_t)event.mouseButton.x, 
